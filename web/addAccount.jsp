...
<html>
    <head>
        ...
        <title>Cấp tài khoản nhân viên</title>
    ...
    <body>
        ...
        %>
        <form method="POST" action="addAccountServlet" onsubmit="return registerInputCheck()">
        <div id="outsite">
        <div id="cover">
            <div id="registertext" class="centerHor">
                <div id="textre">Cấp tài khoản nhân viên</div>
            </div>
		<div id="framefb">
		...
		<div style="padding: 13px" class="centerHor">
                    <input type="submit" value="Tạo tài khoản" ></input>
		</div>
            </div>
        </div>
        </form>
